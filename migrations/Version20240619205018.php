 ...
 */
final class Version20240619205018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product (id INT AUTO_INCREMENT NOT NULL, metadata_id INT NOT NULL, name VARCHAR(255) NOT NULL, summary LONGTEXT NOT NULL, UNIQUE INDEX UNIQ_D34A04ADDC9EE959 (metadata_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
